...
//TEST(casillasAtacadasTEST, alfil_ConObstaculo){
//    tablero  t ={
//            {cVACIA, cREY_N, cVACIA, cVACIA, cALFIL_N, cVACIA, cVACIA, cVACIA},
...
//    vector<coordenada> esperado = {
//            make_pair(0,0), make_pair(0,2), make_pair(1,0), make_pair(1,1), make_pair(1,2), //Rey Negro en (0,1)
//            make_pair(1, 3), make_pair(4,5), make_pair(4,7) //Peon Negro en (3,6)
//
//    };
//
//    vector<coordenada> atacadas = casillasAtacadas(p, j);
